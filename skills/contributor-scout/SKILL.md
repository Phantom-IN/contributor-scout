...
allowed-tools: Read, Glob, Grep, Bash, Write, Edit, WebFetch, WebSearch, TodoWrite, Task
---
...
Invoke as `/contributor-scout <mode> [args]` where the installed Claude Code
...
**Subagents** (project `agents/` directory): `repository-intelligence`,
