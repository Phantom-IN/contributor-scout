...
|---|---|---|---|
| Vaibhav Vanage | [@Phantom-IN](https://github.com/Phantom-IN) | Project lead | 2026-08 |
...
responsibility for the [roadmap](ROADMAP.md). The project lead additionally
owns releases and version tags, coordinates
[security reports](SECURITY.md), and is the enforcement contact for the
...
3. **Tie-break.** When maintainers disagree and evidence does not settle it,
   the project lead has the final call — and records the reasoning in the PR
   or issue.
