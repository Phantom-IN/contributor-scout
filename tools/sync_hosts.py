...
Contributor Scout ships the same skill four times, once per host:

    skills/contributor-scout/           Claude Code   (canonical)
    .github/skills/contributor-scout/   GitHub Copilot
    .cursor/skills/contributor-scout/   Cursor
    .agents/skills/contributor-scout/   Antigravity
...
CANONICAL_SKILL = Path("skills/contributor-scout")
MIRROR_SKILLS = [
    Path(".github/skills/contributor-scout"),
    Path(".cursor/skills/contributor-scout"),
    Path(".agents/skills/contributor-scout"),
]
...
def check_shared_subtrees(write: bool) -> List[str]:
    ...
    for mirror_rel in MIRROR_SKILLS:
            ...
            for name in src_files:
                ...
                if write:
                    ...
                    problems.append("{0}: {1} {2}".format(
                        mirror_rel / subtree / name, state, CANONICAL_SKILL / subtree / name))
    return problems


def check_skill_headings() -> List[str]:
    problems: List[str] = []
    canonical_path = REPO_ROOT / CANONICAL_SKILL / "SKILL.md"
